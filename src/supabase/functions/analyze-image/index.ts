...
serve(async (req) => {
  ...
  try {
    ...
    try {
      // Optimized prompt - more concise and focused on essential information
      const prompt = `
        Identify food items in this image and provide nutritional data.
        Be concise and accurate with estimates.
        
        For each item, include:
        - Name
        - Calories
        - Protein, carbs, fat (grams)
        - 1-2 key health benefits
        - 1 potential health concern (if applicable)
