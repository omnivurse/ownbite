/*
  # Meal Plans Table and Functions

  1. New Tables
    - `meal_plans`
      - Stores AI-generated personalized meal plans
      - Links to user and target nutrients
      - Contains plan data as JSONB
  ...
  3. Functions
    - get_meal_plan_recommendations: Returns nutrient recommendations based on bloodwork
*/
