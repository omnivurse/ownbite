/*
  # Meal Plans and Nutrition Integration

  1. New Tables
    - `meal_plans` - Stores AI-generated meal plans based on nutrient deficiencies
    
  2. Functions
    - `get_meal_plan_recommendations` - Suggests nutrients to target based on bloodwork
  ...
  4. Performance
    ...
    - Add standard indexes for common query patterns
*/
